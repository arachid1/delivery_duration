...
if __name__ == "__main__":
    ...
    # -3 features: no timer feature (1), no avg time features (2)
    ...
    # -9 features: no timer feature (1), no avg time features (2), no long score (2), no short score (2), not trip to customer (2)
    # reinitializing
