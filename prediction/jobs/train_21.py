...
if __name__ == "__main__":
    ...
    #         for f in [4, 12]:
    #             print("new job")
    #             print("parameters.n_estimators = {}".format(n))
    #             print("parameters.min_samples_split = {}".format(m))
    #             print("parameters.max_features = {}".format(f))
    #             parameters.n_estimators = n
    #             parameters.min_samples_split = m
    #             parameters.max_features = f
    train_model()
    initialize_job()
