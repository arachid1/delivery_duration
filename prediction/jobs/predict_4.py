...
def train_model(model_to_be_trained=None):
    ...
    #     for f in ['short_score_by_market_id', 'long_score_by_market_id']:
    #         print("new")
    #         print(f+str(v))
...
if __name__ == "__main__":
    ...
    p.decision_features.remove('long_score_by_market_id')
    p.decision_features.remove('short_score_by_market_id')
    p.decision_features.remove('long_score_by_store_id')
    p.decision_features.remove('short_score_by_store_id')
    p.decision_features.remove('trip_to_customer_by_market_id')
    p.decision_features.remove('trip_to_customer_by_store_id')
