...
if __name__ == "__main__":
    ...
    parameters.sequential = tf.keras.Sequential(
        [tf.keras.layers.Dense(
            1024, activation="sigmoid", activity_regularizer=tf.keras.regularizers.l2(
                parameters.ll2_reg)),
         tf.keras.layers.Dropout(0.1),
         tf.keras.layers.Dense(
             512, activation="relu", activity_regularizer=tf.keras.regularizers.l2(
                 parameters.ll2_reg)),
         tf.keras.layers.Dropout(0.1),
         tf.keras.layers.Dense(
             256, activation="relu", activity_regularizer=tf.keras.regularizers.l2(
                 parameters.ll2_reg)),
         tf.keras.layers.Dropout(0.1),
         tf.keras.layers.Dense(
             128, activation="relu", activity_regularizer=tf.keras.regularizers.l2(
                 parameters.ll2_reg)),
         tf.keras.layers.Dropout(0.1),
