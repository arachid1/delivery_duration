...
def train_model(model_to_be_trained=None):
    ...
    #  'created_at_week_day', 'created_at_hour', 'created_at_month', 'created_at_day_of_month',
    #  'prev_orders_market_id', 'prev_orders_store_id']
    # parameters.features = [
    #     'market_id', 'store_id', 'subtotal', 'total_onshift_dashers', 'total_busy_dashers',
    #     'total_outstanding_orders', 'estimated_store_to_consumer_driving_duration',
    #     'created_at_week_day', 'created_at_hour', 'created_at_day_of_month',
    #     'prev_orders_market_id']
...
if __name__ == "__main__":
    ...
    parameters.feature_generation = True
